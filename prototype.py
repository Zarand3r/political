...
def trainSVD2(training_data, colorlabels, plot=True, savefig=True): #colorlabels, sizelabels, plot=True, savefig=True
	# algo = SVD(n_factors=4, n_epochs=1000, biased=True)
	# algo = SVD(n_factors=20, n_epochs=500, biased=False)
	algo = SVDpp(n_factors=100, n_epochs=1000)
